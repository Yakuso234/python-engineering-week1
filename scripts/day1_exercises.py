...
# 测试用例
print(
    "第11题测试：", selection_sorted([3, 1, 4, 1, 5, 9, 2, 6])
)  # 输出 [1,1,2,3,4,5,6,9]
...
print(
    "第12题测试：", sort_dict_by_values(test_dict)
)  # 输出 [('d',1),('b',2),('a',5),('c',8)]
...
d2 = {"age": 21, "city": "广州"}
print(
    "第13题测试：", merge_dicts(d1, d2)
)  # 输出 {'name':'小明','age':21,'city':'广州'}


# ======================
# 第14题：文本文件读写（文件读写考点）
# ======================
# 对给定的文本（英文单词文本）进行word和char计数
def count_text_file(file_path: str) -> dict[str, int]:
...
# 测试用例
print(
    "第16题测试(A man, a plan, a canal: Panama)：",
...
# 测试用例
print(
    "第17题测试([flower,flow,flight])：",
    longest_common_prefix(["flower", "flow", "flight"]),
)  # fl
print(
    "第17题测试([dog,racecar,car])：", longest_common_prefix(["dog", "racecar", "car"])
)  # 空字符串
